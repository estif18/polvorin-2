-- =========================================================
-- SCRIPT DE CREACIÓN PARA AZURE SQL DATABASE - PALLCA
-- =========================================================
-- Fecha: Noviembre 2025
-- Versión: 1.0 Azure
-- Descripción: Script específico para Azure SQL Database
--              NO intenta crear la base de datos (ya debe existir)

-- =========================================================
-- NOTA: Este script debe ejecutarse CONECTADO a la base pallca
-- =========================================================

PRINT '🔍 Verificando conexión a base de datos PALLCA en Azure...';
SELECT DB_NAME() as BaseDatosActual;

-- =========================================================
-- 1. CREAR TABLA EXPLOSIVOS (MAESTRO)
-- =========================================================
...
PRINT '';
PRINT '🎉 ¡SCRIPT DE ESTRUCTURA AZURE EJECUTADO EXITOSAMENTE!';
PRINT '';
PRINT '📊 PROCESO COMPLETADO:';
PRINT '   ✅ Base de datos PALLCA (Azure SQL Database)';
...
PRINT '';
PRINT '🚀 SIGUIENTE PASO: Ejecutar 02_crear_vistas_optimizadas_azure.sql';
PRINT '';